...
begin
  ...
  add_import_path '../vendor/bootstrap-sass/assets/stylesheets'
end

#css_dir = "../../../libraries/mytheme_bootstrap/css" # Compiled CSS goes here.
#javascripts_dir = "../../../libraries/mytheme_bootstrap/js" # Compiled JS goes here.

css_dir = "../dist/css" # Compiled CSS goes here.
javascripts_dir = "../dist/js" # Compiled JS goes here.
